...
class MainActivity : AppCompatActivity() {
    ...
    //internal var btnUp: Button? = null
    var downButton = findViewById<com.google.android.material.floatingactionbutton.FloatingActionButton>(R.id.btnTempDown)
    var upButton = findViewById<com.google.android.material.floatingactionbutton.FloatingActionButton>(R.id.btnTempUp)
    internal var btnDown: Button? = null
    private var currTempDisplay = null;
    private var desTempDisplay = null;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currTempDisplay = findViewById(R.id.btnCurrentTempDisplay)
        desTempDisplay = findViewById(R.id.btnDesiredTempDisplay)
        ...
        upButton!!.setOnClickListener {
            ...
            //make function to turn up the number and send signal to system
        }

        downButton!!.setOnClickListener {
            tempChange("0")
            Toast.makeText(baseContext, "Turn LED OFF: Sending Char 0 ", Toast.LENGTH_SHORT).show()
            //make function to turn down the number and send signal to system
        }
    }
